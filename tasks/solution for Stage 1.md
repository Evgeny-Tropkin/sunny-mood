...
7. Для сортировки порядка отрисовки объектов воспользоваться атрибутом "Order in layer" компонента "Sprite Renderer". Отдельные слои создавать не требуется.
8. Отрегулировать масштаб sprite-ов и настройки камеры, для оптимального вида уровня